        ...
        <motion.button
            ...
            className={`
                ${isInline
                    ...
                    : `fixed z-40 w-14 h-14 bg-[#0088cc] text-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,136,204,0.4)] transition-shadow hover:shadow-[0_0_30px_rgba(0,136,204,0.6)] ${
                        isWhatsAppVisible 
            ...
            `}
        >
            <FaTelegramPlane size={isInline ? 18 : 32} />
